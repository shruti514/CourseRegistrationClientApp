...
public class AuthHeaderParser {
    ...
    private static final Logger logger = LoggerFactory.getLogger(AuthHeaderParser.class);
    /**
     ...
     * AuthHeaderParser.BASIC  - basic, and
     * AuthHeaderParser.DIGEST - digest (algorithm=MD5, QOP="auth").
     */
    private int mScheme;
     ...
     */
    public AuthHeaderParser(String header) {
        if (header != null) {
            parseHeader(header);
        }
    }
    ...
    private void parseHeader(String header) {
        logger.debug("AuthHeaderParser.parseHeader(): header: " + header);
